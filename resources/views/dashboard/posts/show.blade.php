...
<div class="container">
    <div class="row my-3">
        <div class="col-lg-8">
            ...
            <a href="/dashboard/posts" class="btn btn-dark"><span data-feather="arrow-left"></span> Back to all my posts</a>
            ...
            <p class="mt-3">By. {{ $post->author->name }} in {{ $post->category->name }}</p>
